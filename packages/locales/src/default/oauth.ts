export default {
  ...
  'consent.scope.openid': 'Authenticate using your Chituo AI Assistant account',
  ...
  'consent.thirdParty.notice':
    'This application is created by a third-party developer and is not operated by Chituo AI Assistant. Once authorized, it can act on your behalf and use your account quota.',
