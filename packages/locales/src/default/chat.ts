export default {
  ...
  'createModal.skillSuggestion.actions.tryInLobeAI': 'Use in Chituo AI Assistant',
  ...
  'createModal.skillSuggestion.installed.description':
    'You can use this Skill in Chituo AI Assistant or add it to any Agent.',
  'createModal.skillSuggestion.installed.ready': 'Ready in Chituo AI Assistant',
  ...
  'ampInstallGuide.reason': 'Chituo AI Assistant could not start Amp: {{message}}',
  ...
  'opencodeInstallGuide.reason': 'Chituo AI Assistant could not start OpenCode: {{message}}',
  ...
  'platformAgent.create.upgradeCmd':
    'npm install -g https://www.gdibao.com/downloads/v2.2.13-chituo.7/ct-claw-fab-cli-2.2.13-chituo.7.tgz',
  ...
  'sharePage.menu.goToLobeHub': 'Go to Chituo AI Assistant',
  ...
  'sharePageDisclaimer':
    "Shared by a user. The content reflects their views, not Chituo AI Assistant's, and Chituo AI Assistant takes no responsibility for it.",
  ...
  'taskList.unassignedHint': '{{brandName}} will run this task when no assignee is set',
