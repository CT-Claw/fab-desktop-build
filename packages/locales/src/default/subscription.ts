export default {
  ...
  'keyMissMatch.description':
    'Due to an occasional system failure, your current subscription usage is temporarily inactive. Please click the button below to restore usage and continue the conversation. If this happens repeatedly, please contact us via email (wodekefu@gmail.com)',
  ...
  'admin.providers.field.lobeHubOfficialPricing': '使用 Chituo AI Assistant 官方价格',
