export default {
  ...
  'channel.comingSoonDesc':
    'We are working on bringing this integration to Chituo AI Assistant. Stay tuned for updates.',
  ...
  'channel.messengerPromo.desc':
    'No bot setup. Chat with Chituo AI Assistant on Slack, Discord, Telegram.',
  ...
  'channel.connectionError.connection_closed':
    'The platform connection was interrupted. Chituo AI Assistant will try to reconnect automatically.',
  ...
  'channel.connectionError.upstream_unavailable':
    'The platform service is temporarily unavailable. Chituo AI Assistant will try again later.',
  ...
  'channel.imessage.description':
    'Connect this agent to iMessage through the local Chituo AI Assistant Desktop BlueBubbles bridge.',
  ...
  'channel.imessage.blueBubblesPasswordHint':
    'Stored locally in Chituo AI Assistant Desktop and used only to call the local BlueBubbles server.',
  ...
  'channel.imessage.blueBubblesServerUrlTip':
    'If BlueBubbles and Chituo AI Assistant Desktop run on the same Mac, use 127.0.0.1; if they run on different devices, enter the LAN IP.',
  'channel.imessage.bridgeEnabled': 'Enable Bridge',
  'channel.imessage.bridgeEnabledHint':
    'When enabled, Chituo AI Assistant Desktop receives local BlueBubbles webhooks and forwards them to Chituo AI Assistant.',
  'channel.imessage.bridgeRunningDesc':
    'This local relay forwards iMessage messages to Chituo AI Assistant. You can now test the BlueBubbles connection.',
  'channel.imessage.bridgeRunningDescListening':
    'Listening on {url}, relaying iMessage messages to Chituo AI Assistant. You can now test the BlueBubbles connection.',
  ...
  'channel.imessage.bridgeStoppedDesc':
    'Enable the bridge to relay iMessage messages to Chituo AI Assistant, then test the connection.',
  ...
  'channel.imessage.desktopDeviceIdHint':
    'The Chituo AI Assistant Desktop device that runs the local BlueBubbles bridge. Find it in Desktop Gateway settings.',
  ...
  'channel.imessage.webhookSecretHint':
    'A shared secret used between Chituo AI Assistant Desktop and the cloud webhook. Use the same value in the Desktop bridge config.',
