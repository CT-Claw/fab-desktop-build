export default {
  ...
  'messenger.detail.commands.feedback':
    'Send feedback to the Chituo AI Assistant team (no AI reply), e.g. /feedback your message',
  ...
  'messenger.detail.commands.start': 'Link your account to Chituo AI Assistant',
  ...
  'messenger.linkModal.instructions':
    'Open the bot, send /start, then tap "Link Account" to connect your {{brandName}} account.',
  ...
  'messenger.slack.connectModal.description':
    'You will be redirected to Slack to authorize the {{brandName}} workspace install.',
  ...
  'messenger.slack.connections.disconnectConfirm':
    'Disconnect the {{brandName}} bot from this Slack workspace? Existing user links will pause until you re-install.',
  ...
  'messenger.slack.installBlocked.suggestion':
    "DM the {{brandName}} bot on Slack to link your personal account — you don't need to install again. Or ask the original installer to disconnect this workspace first if you want to take over ownership.",
  'messenger.slack.installBlocked.title': 'Workspace already connected',
  'messenger.slack.installBlocked.withName':
    '"{{workspace}}" is already connected to {{brandName}} by another user.',
  'messenger.slack.installBlocked.withoutName':
    'This Slack workspace is already connected to {{brandName}} by another user.',
  ...
  'messenger.discord.connectModal.description':
    'Add the {{brandName}} bot to a Discord server you manage.',
  ...
  'messenger.discord.installBlocked.suggestion':
    "DM the {{brandName}} bot on Discord to link your personal account — you don't need to add the bot again. Or ask the original installer to remove this server in {{brandName}} Settings → Messenger before re-adding it.",
  ...
  'messenger.discord.installBlocked.withoutName':
    'This Discord server is already connected to {{brandName}} by another user.',
  ...
  'messenger.list.discord.description':
    'Chat with your {{brandName}} agents on Discord by DMing the {{brandName}} bot from any server.',
  'messenger.list.slack.description':
    'Chat with your {{brandName}} agents on Slack by DMing or mentioning the {{brandName}} bot in any workspace.',
  'messenger.list.telegram.description':
    'Chat with your {{brandName}} agents on Telegram, and choose which agent replies.',
  'messenger.list.wechat.description':
    'Scan with WeChat to chat privately with your {{brandName}} agents and switch agents with /agents.',
  ...
  'messenger.subtitle':
    'Connect your account to the official {{brandName}} bot once. Pick which agent receives messages, switch any time from here or from the bot.',
  'messenger.title': 'Messenger',
  'messenger.unlinkConfirm':
    'Disconnect your {{platform}} account from {{brandName}}? Inbound messages will stop until you /start again.',
  'messenger.unlinkConfirmWechat':
    'Disconnect your WeChat account from {{brandName}}? Inbound messages will stop until you scan the QR code to reconnect.',
  ...
  'messenger.wechat.error.alreadyLinkedToOther':
    'This WeChat account is already connected to another Chituo AI Assistant account.',
  ...
  'verify.confirm.conflict.description':
    'This {{platform}} account is already linked to {{brandName}} account {{email}}. Sign in to that account to manage the link, or unlink there before retrying.',
  ...
  'verify.confirm.fields.lobeHubAccount': '{{brandName}} account',
  'verify.confirm.fields.platformAccount': '{{platform}} account',
  'verify.confirm.fields.workspace': 'Workspace',
  'verify.confirm.noAgents':
    "You don't have any agents yet. Create one in {{brandName}}, then come back to finish linking.",
  'verify.confirm.relink.description':
    'This {{brandName}} account is already linked to {{platform}} account {{account}}. To link a different {{platform}} account, disconnect the current one first in Settings → Messenger.',
  ...
  'verify.error.alreadyConsumed':
    'This link has already been used to connect an account. Sign in to that {{brandName}} account to manage the connection, or return to the bot and send /start again to issue a new link.',
  'verify.error.alreadyConsumedTitle': 'This link is already used',
  'verify.error.alreadyLinkedToOther':
    'This account is already linked to a different {{brandName}} account. Sign in to that account first.',
  ...
  'verify.error.unlinkBeforeRelink':
    'This {{brandName}} account is already linked to another account on this platform. Disconnect it in Settings → Messenger before linking a new one.',
  'verify.signInCta': 'Sign in to continue',
  'verify.signInRequired': 'Please sign in to {{brandName}} to confirm the link.',
  'verify.success.backToLobeHub': 'Back to {{brandName}}',
