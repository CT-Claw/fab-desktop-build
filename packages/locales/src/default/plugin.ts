export default {
  ...
  // Legacy aliases keep historical tool calls labeled.
  ...
  'protocolInstall.official.badge': 'Chituo AI Assistant Official Skill',
  'protocolInstall.official.description':
    'Official Chituo AI Assistant Skill, verified and security-checked.',
  ...
  'protocolInstall.stdio.commandExecution.description':
    'STDIO MCPs connect through a local command. During installation, Chituo AI Assistant will start the command shown below to test the connection. Continue only if you trust this source.',
  ...
  'skillDetail.trustWarning':
    "Only use connectors from developers you trust. Chituo AI Assistant does not control which tools developers make available and cannot verify that they will work as intended or that they won't change.",
  ...
  'store.tabs.mcp': 'MCP',
  'store.tabs.old': 'Chituo AI Assistant Skills',
  'store.title': 'Skill Store',
  'unknownError': 'Unknown error',
  'unknownPlugin': 'Unknown Skill',
  'builtins.lobe-agent-documents.inspector.target.agent': 'Agent',
  'builtins.lobe-agent-documents.inspector.target.currentTopic': 'Current topic',
  'builtins.lobe-web-onboarding.inspector.charCount': '{{count}} chars',
  'builtins.lobe-web-onboarding.inspector.hunkCount': '{{count}} changes',
  'builtins.lobe-web-onboarding.inspector.interests': '{{count}} interests',
