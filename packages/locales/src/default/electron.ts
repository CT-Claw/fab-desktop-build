export default {
  ...
  'navigation.experts': 'Expert Plaza',
  ...
  'navigation.lobehub': 'Chituo AI Assistant',
  ...
  'remoteServer.configDesc':
    'Connect to the remote Chituo AI Assistant server to enable data synchronization',
  ...
  'sync.lobehubCloud.title': 'Chituo AI Assistant Service',
