export default {
  ...
  'email.footer.preference':
    'You received this email because of your notification settings on Chituo AI Assistant.',
  'email.footer.system': 'This is an important account notification from Chituo AI Assistant.',
