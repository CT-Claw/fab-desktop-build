export default {
  'localMarket.officialCommunity': 'Local quality market',
  'localMarket.domain': 'All domains',
  'localMarket.category': 'All roles',
  'localMarket.brand': 'All brands',
  'localMarket.back': 'Back to workspace',
  'localMarket.title': 'Local Assistant Market',
  'localMarket.local': 'Local assistants',
  'localMarket.officialExternal': 'Open local quality market (new window)',
  'localMarket.nav.market': 'Local market',
  'localMarket.nav.assistants': 'Local assistant market',
  'localMarket.nav.skills': 'Local skills market',
  'localMarket.nav.mcp': 'Local MCP market',
  'localMarket.nav.models': 'Local model market',
  'localMarket.nav.providers': 'Local model provider market',
  'localMarket.search': 'Search assistants',
  'localMarket.dependencies':
    'Model: uses site/user settings. Knowledge retrieval is not connected. Engineering tools are not installed.',
  'localMarket.disabledTools': 'Unverified, disabled: {{names}}',
  'localMarket.prompt': 'Instructions and opening questions',
  'localMarket.install': 'Add / open my copy',
  'localMarket.signIn': 'Sign in to add',
  'localMarket.installError':
    'Unable to add this assistant. Check your local sign-in and permissions, then retry.',
  'localMarket.empty': 'No matching assistants',
  ...
  'assistants.status.support':
    'For any questions, please copy the link and send it to <email>wodekefu@gmail.com</email> for assistance.',
  'assistants.status.unpublished.subtitle':
    'This Agent is under review. To confirm its status, copy the link and email <email>wodekefu@gmail.com</email>.',
  ...
  'createGuide.func1.title': 'Submit in Chituo AI Assistant',
  ...
  'footer.desc':
    'Evolve with AI users worldwide. Become a creator to submit your agents and skills to the Chituo AI Assistant Community.',
  'footer.title': 'Share your creation on Chituo AI Assistant Community today',
  ...
  'models.providerInfo.apiTooltip':
    'Chituo AI Assistant supports using a custom API key for this provider.',
  ...
  'models.providerInfo.officialTooltip': 'Chituo AI Assistant Official Service',
