export default {
  ...
  'notSupportGuide.desc':
    'The current deployment mode does not support file management. Switch to <1>server database deployment mode</1>, or use <3>Chituo AI Assistant Service</3>.',
