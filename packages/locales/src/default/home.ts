export default {
  ...
  'dashboard.customize.group.decoration': 'Decoration',
  'dashboard.customize.group.listSize': 'List size',
  'dashboard.customize.group.sections': 'Sections',
  ...
  'dashboard.customize.tasks.count.title': 'Tasks',
  ...
  'dashboard.customize.widget.tasks': 'Tasks',
  ...
  'recommendations.heteroAgent.description':
    'Detected the {{name}} CLI on this device — add {{name}} agent to chat with it from Chituo AI Assistant.',
