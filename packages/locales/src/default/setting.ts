export default {
  ...
  'devices.connectWizard.cli.installDesc':
    'Install the Chituo AI Assistant CLI globally with your preferred package manager to enable device connectivity and management.',
  ...
  'downloads.desktop.desc':
    'Download the released Windows, Linux, and CLI clients from the Chituo website. macOS is pending.',
  'downloads.desktop.title': 'Desktop App',
  'downloads.messenger.cta': 'Open Messenger settings',
  'downloads.messenger.desc':
    'Configure Telegram, Slack, Discord, or WeChat bots. Availability depends on administrator setup.',
  'downloads.messenger.quickSetup': 'Quick setup',
  'downloads.messenger.quickSetupTooltip':
    'You can chat with the official Chituo AI Assistant account on this platform or manually set up your own.',
  'downloads.messenger.title': 'Messenger integration',
  'downloads.mobile.cta': 'Not released yet',
  'downloads.mobile.desc':
    'Native Chituo apps for iOS and Android are not released yet. Use this site in your mobile browser for now.',
  'downloads.mobile.title': 'Mobile App (Pending)',
  'downloads.title': 'Chituo AI Assistant downloads and integrations',
  ...
  'notification.push.desc':
    'Send push notifications to your mobile devices (Chituo AI Assistant mobile app required)',
  ...
  'settingAgent.agentTools.connectNew.desc': 'Connect an external service or third-party connector',
  'settingAgent.agentTools.connectNew.title': 'Connect external tool',
  'settingAgent.agentTools.connectNewPickerTitle': 'Connect an external tool for this Agent',
  ...
  'settingAgent.agentTools.pickerEmpty':
    'No external user connectors are available. Fab built-in skills, knowledge and tools are shown in the tool list below.',
  ...
  'settingAppearance.appTray.desc':
    'Show the Chituo AI Assistant icon in the system tray or macOS menu bar. Disabling it also removes tray menu access.',
  ...
  'settingSelfIteration.enabled.managedDesc':
    'Always on for Chituo AI Assistant while Self-Iteration is available.',
  ...
  'settingSystemTools.tools.lobehub.desc':
    'Chituo AI Assistant CLI - manage and connect to Chituo AI Assistant services',
...
💡 Tip: The more specific your description, the better we can meet your needs`,
  ...
  'storage.actions.transfer.desc':
    'Move agents and their data to another Workspace or your personal account. The originals leave the current space. Chituo AI Assistant cannot be moved; copy it instead.',
  ...
  'workspace.apiKey.upgrade.benefits.integration.desc':
    'Call workspace agents and resources from your own systems via the Chituo AI Assistant API.',
  ...
  'workspace.general.devReset.description':
    'Reopens the setup wizard so you can revise Chituo AI Assistant, pick new scenarios, or invite more teammates. Your existing settings and data are kept.',
  ...
  'workspace.general.copyLobeAI.modal.defaultInboxTitle': 'Chituo AI Assistant',
  ...
  'workspace.onboarding.skipConfirm.description':
    'You can always customize Chituo AI Assistant and add agents later in Workspace settings.',
  ...
  'workspace.onboarding.step1.heading': 'Personalize Chituo AI Assistant',
  ...
  'workspace.onboarding.step1.nameLabel': "Chituo AI Assistant's name",
  'workspace.onboarding.step1.namePlaceholder': 'e.g. Chituo AI Assistant',
  ...
  'workspace.onboarding.step1.footer':
    "Set up your workspace's Chituo AI Assistant assistant — it learns from every conversation and grows into your team's go-to teammate.",
  ...
  'tools.builtins.lobe-skill-store.description':
    'Browse and install agent skills from the Chituo AI Assistant marketplace. Use this when you need extended capabilities or want to install a specific skill.',
