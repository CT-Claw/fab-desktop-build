export default {
  ...
  'heteroImport.badge.linked': 'From Chituo AI Assistant',
  'heteroImport.badge.linkedTip':
    'This session was started from Chituo AI Assistant and already lives in your topic list',
  ...
  'heteroImport.error.desc':
    'Could not read the local sessions. Check that Chituo AI Assistant can access your transcripts, then retry.',
