...
import { Block, CopyButton, Flexbox, Icon, ThemeProvider } from '@lobehub/ui';
import { Button, ScrollArea, Text } from '@lobehub/ui/base-ui';
import { createStaticStyles, cx } from 'antd-style';
import { ChevronRight, Download, MessageCircle, Monitor, Smartphone, Terminal } from 'lucide-react';
            ...
            <Block className={cx(styles.card, styles.desktopCard)}>
              <Flexbox gap={18} height="100%">
                ...
                <Flexbox horizontal className={styles.actionRow} gap={10}>
                  <Button icon={Download} onClick={() => openExternal(CHITUO_DOWNLOADS_URL)}>
