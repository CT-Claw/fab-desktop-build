...
import { parseModelSelection } from './parseModelSelection';
        ...
        label: (
          <Flexbox gap={4}>
            <Flexbox horizontal align={'center'} gap={8}>
              ...
              <Tooltip
                title={t(`ModelSelect.staleModel.${status}.tooltip`, {
                  successorName,
                })}
              >
                <Tag
        ...
        <Select
          ...
          onChange={(next, option) => {
            ...
            const selection = parseModelSelection(
              next,
              (option as unknown as ModelOption | undefined)?.provider,
            );
