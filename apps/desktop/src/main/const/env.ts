...
export const DESKTOP_APPLICATION_ID = getDesktopEnv().DESKTOP_APPLICATION_ID;
export const DESKTOP_APPLICATION_NAME = getDesktopEnv().DESKTOP_APPLICATION_NAME;
export const DESKTOP_OIDC_CLIENT_ID = getDesktopEnv().DESKTOP_OIDC_CLIENT_ID;
export const DESKTOP_PROTOCOL_SCHEME = getDesktopEnv().DESKTOP_PROTOCOL_SCHEME;
