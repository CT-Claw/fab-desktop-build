...
const getRuntimeEnv = () => ({
  ...
  DESKTOP_APPLICATION_ID: process.env.DESKTOP_APPLICATION_ID,
  DESKTOP_APPLICATION_NAME: process.env.DESKTOP_APPLICATION_NAME,
  DESKTOP_EXTERNAL_NAVIGATION_HOSTS: process.env.DESKTOP_EXTERNAL_NAVIGATION_HOSTS,
  DESKTOP_OIDC_CLIENT_ID: process.env.DESKTOP_OIDC_CLIENT_ID,
...
export const getDesktopEnv = memoize(() =>
  createEnv({
    ...
    server: {
      ...
      DESKTOP_APPLICATION_ID: z.string().optional().default('com.gdibao.chituoai'),

      DESKTOP_APPLICATION_NAME: z.string().optional().default('驰拓 AI 助手'),

      DESKTOP_OIDC_CLIENT_ID: z.string().optional().default('lobehub-desktop'),

      DESKTOP_PROTOCOL_SCHEME: z.string().optional().default('chituoai'),
      ...
      OFFICIAL_CLOUD_SERVER: z.string().url().optional().default('https://fab.gdibao.com'),
